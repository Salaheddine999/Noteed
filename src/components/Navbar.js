                ...
                <nav className="ml-auto gap-4 sm:gap-6 hidden sm:flex">
                    {isAuthenticated ? 
                        ...
                        <> 
                            ...
                            <a className="text-sm font-medium hover:underline underline-offset-4" href="#upcoming">
                                Upcoming
                            </a>
                        </>
                    ...
                    <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow rounded-box w-52">
                        {isAuthenticated ? 
                            <>
                                ...
                                <li><Link className="text-sm font-medium rounded-md" to="/">
                                    Home
                                </Link></li>
                                <li><a className="text-sm font-medium rounded-md">
                                    <LogoutButton />
                                </a></li>
                            ...
                            <> 
                                ...
                                <li><a className="text-sm font-medium rounded-md" href="#features">
                                    Features
                                </a></li>
                                <li><a className="text-sm font-medium rounded-md" href="#upcoming">
                                    Upcoming
                                </a></li>
                            </>
                        }
