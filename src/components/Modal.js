        ...
        <>
          <input type="checkbox" id={`my-modal-${id}`} className="modal-toggle" />
            ...
            <div className="modal-action">
                <label htmlFor={`my-modal-${id}`} className="btn btn-warning btn-outline rounded-md font-normal normal-case border-2" onClick={deleteNote}>Delete</label>
                <label htmlFor={`my-modal-${id}`} className="btn btn-outline rounded-md font-normal normal-case border-2">Cancel</label>
            </div>
            </div>
            </div>
        </>
