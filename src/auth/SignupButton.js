...
const SignupButton = () => {
    ...
    return (
        <button
            className="btn btn-md sm:btn-lg sm:px-10 normal-case btn-primary font-medium text-lg sm:text-xl rounded-xl mb-4 border-2 hover:bg-white hover:text-black"
            onClick={() =>
                loginWithRedirect({
                    screen_hint: 'signup',
                })
